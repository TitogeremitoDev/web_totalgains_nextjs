                ...
                <div className="footer-content">
                    <div className="footer-brand">
                        ...
                        <div className="footer-social">
                            ...
                            <a href="https://www.tiktok.com/@totalgainsfitness" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="TikTok">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="https://www.youtube.com/@totalgainsfitness" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="YouTube">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
