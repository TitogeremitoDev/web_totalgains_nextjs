...
readTime: 12
image: "/images/blog/entrenar-ciclo-menstrual-hero.webp"
imageWidth: 1344
imageHeight: 768
faqs:
  - q: "¿De verdad afecta el ciclo menstrual al rendimiento en el gimnasio?"
    a: "Sí, pero no como venden los cursos. La mejor evidencia disponible (McNulty et al., Sports Medicine 2020) confirma que las plantillas de fases teóricas no predicen bien el rendimiento porque cada mujer vive el ciclo de forma distinta. Lo que sí está documentado: la retención de líquidos premenstrual altera la báscula 0,5-2 kg (rompe la adherencia si no se explica), el síndrome premenstrual sube la percepción de esfuerzo (mismo entreno se siente más duro), y los antojos son previsibles cuando registras 3-4 ciclos. Los tres se pueden ajustar con datos individuales."
  - q: "¿Puedo diseñar un plan de entrenamiento distinto por cada fase del ciclo?"
    a: "Puedes, pero por defecto no funciona bien. Los estudios agrupados no encuentran diferencias consistentes en fuerza o resistencia entre fases teóricas del ciclo. Lo que sí funciona es distinto: observar el ciclo REAL de tu clienta durante 3-4 meses, identificar sus días concretos de bajo rendimiento (que no coinciden con la teoría) y ajustar el RPE de esos días específicos. Es individualización, no plantilla."
  - q: "¿Cómo evito que la báscula premenstrual rompa la dieta de mi clienta?"
    a: "Explicándolo el primer día del plan y anticipándolo cada mes. En los 3-5 días previos a la regla es normal retener 0,5-2 kg de agua. No es grasa, no es fallo del plan, se resuelve solo en 4 días. Una clienta que sabe esto se pesa el jueves, ve +1,4 kg y sigue con el plan. Una clienta que no lo sabe se ha comido tres pizzas el fin de semana antes del domingo."
  - q: "¿Qué tiene Mi Ciclo de TotalGains que no tiene un tracker menstrual normal?"
    a: "Un tracker suelto sabe cuándo bajas la regla pero no sabe qué comes ni qué entrenas. Una app de fitness estándar sabe qué comes y entrenas pero ignora el ciclo. Mi Ciclo une los tres dentro de la misma app: marca en tu plan de nutrición qué comida encaja mejor con el momento del mes, señala tu ventana fuerte para las cargas altas basándose en TUS últimos 4 ciclos (no en los 28 de los libros), y explica los picos de báscula antes de que te frustres. Cuando tu coach lo activa contigo, ve la fase actual y ajusta la semana."
  - q: "¿Es seguro compartir mis datos del ciclo con mi entrenador o entrenadora?"
    a: "Depende de la plataforma. En Mi Ciclo de TotalGains todo empieza en privado por defecto: la entrenadora no ve nada hasta que tú activas casilla a casilla qué compartir (fase, síntomas, ventana de fuerza). El diario personal, la vida sexual, el autoexamen de mamas y el cuestionario ginecológico no se comparten nunca, ni con permisos. Esa parte no viaja del móvil, es decisión técnica, no una casilla que se pueda pulsar por error."
  - q: "¿Cuánto tiempo tarda Mi Ciclo en aprender el ciclo real de una clienta?"
    a: "Tres o cuatro ciclos completos suelen bastar para pasar de la estimación teórica (28 días) a los datos personales. A partir del cuarto registro, la app deja de usar la media estándar y trabaja con la duración media real de esa mujer, sus días típicos de SPM y su patrón de energía. Todos los avisos llevan la etiqueta 'basado en tus últimos X ciclos registrados', para que la clienta y la coach vean que no es teoría."
---

<div class="tg-callout tg-callout-panic" role="note">
<strong>Respuesta rápida.</strong> El ciclo menstrual afecta al entreno y a la dieta de tres formas medibles: la retención de líquidos que rompe la adherencia a la báscula (0,5-2 kg), los días de bajo rendimiento consistentes que llevan a lesiones si se empuja, y los antojos previsibles que hacen fallar la dieta si no se anticipan. Las plantillas de 28 días de los libros no capturan nada de esto porque cada mujer es distinta. Lo que sí funciona es observar el ciclo real de cada clienta y ajustar el plan que ya tiene, no crearle uno nuevo.
</div>
...
<div class="__evidence_level_grid__"></div>
...
![Mesita de noche con móvil boca abajo, vela encendida, libro abierto boca abajo, vaso de agua y llave de latón, atmósfera íntima con lámpara cálida](/images/blog/entrenar-ciclo-menstrual-privacidad.webp "Lo tuyo es tuyo. Compartir es una decisión activa, no una casilla marcada por defecto.")
