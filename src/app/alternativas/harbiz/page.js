    ...
    "@graph": [
      ...
      organizationNode(),
      {
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "¿Cobráis comisiones por las ventas que hago a mis clientes?", acceptedAnswer: { "@type": "Answer", text: "Cero comisiones: TotalGains no toca tus ingresos ni se mete entre tú y tu cliente. El cobro lo haces por tu canal de siempre (transferencia, Bizum, TPV o tu propio enlace de pago, fuera de la app) y lo registras en la ficha del atleta, que guarda el historial y te avisa de las renovaciones. Dentro de la aplicación todavía no hay pasarela de pago." } },
