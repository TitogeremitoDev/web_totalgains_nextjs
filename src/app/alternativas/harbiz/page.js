    ...
    "@graph": [
      {
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "¿Por qué TotalGains es mejor alternativa a Harbiz para entrenadores en España?", acceptedAnswer: { "@type": "Answer", text: "TotalGains incluye IA que genera rutinas y dietas con tu propia base de datos, app marca blanca en el plan Pro (89,90 €/mes), sistema de retención asistida con recordatorios de renovación al cliente y soporte en español. Harbiz cobra Personaliza tu app, Nutri AI y Biblioteca de Vídeos como add-ons separados, lo que para funcionalidad equivalente eleva el coste a ~313 €/mes con IVA (verificado mayo 2026)." } },
